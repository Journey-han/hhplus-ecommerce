package io.hhplus.ecommerce.api.controller;

import io.hhplus.ecommerce.api.application.service.ProductService;
...
public class ProductController {
    ...
    public ResponseEntity<ProductResponse> getOneProduct(
        ...
        ProductResponse products = productService.getOneProducts(productId);
        return ResponseEntity.ok(products);
    }
